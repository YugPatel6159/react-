...
import {Autocomplete, Button, Box, TextField, Stack, Rating, Paper, FormControl, FormControlLabel, FormLabel, Radio, RadioGroup } from "@mui/material";
...
function Addproduct() {
  ...
  const relatedProducts =  [
    ...
    },
    {
      id: 2,
      name: "Product B",
      description: "Nulla accumsan, metus ultrices eleifend gravida, nulla nunc varius lectus.",
        ...
        <Box>
          ...
          <Stack direction="row" marginTop={3} spacing={4}>
            ...
            <Autocomplete
             ...
             value={formik.values.relatedProducts.name}
             onChange={(value)=>{formik.setFieldValue('relatedProducts',value.target.outerText)}}
             onBlur={formik.handleBlur}
